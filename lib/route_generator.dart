...
import 'package:food_delivery_app/src/pages/allow_map.dart';
import 'package:food_delivery_app/src/pages/sorry.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/allow':
        return MaterialPageRoute(builder: (_) => AllowMap());
      case '/sorry':
        return MaterialPageRoute(builder: (_) => Sorry());
